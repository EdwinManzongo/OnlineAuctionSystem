...
<body>
        ...
        <?php 
            ...
            if (isset($_POST['search'])){
             ...
             if($status == 'ongoing'){
                $query2 = "SELECT * FROM item where ItemName like '%$keyword%' AND EndTime > '$date' ";
             }
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product same-height">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price">ZWL$ <?php echo number_format($searchResults['CurrentPrice'],2);?></p>
                                </div>
                            </div>
                            <!-- /.product -->
                        </div>
