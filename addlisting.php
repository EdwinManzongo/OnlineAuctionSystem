						...
						2. Tell more about your product.
                                ...
                                <div id="collapseTwo" class="panel">
                                    ...
                                    <label class="control-label col-sm-2" >Image</label>
                                        <div class="col-sm-10">
                                            <br>
                                            <!-- <input type="text" class="form-control" name="PhotosID" placeholder="Upload File"> -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-inline">
                                                <input class="form-control btn-danger" type="submit" align="center" value="ZWL$">
                                       ...
                                       <div class="container" >
                                        ...
                                        <div class="container">
                                            <input required type="date" class="date-picker" type="text" id="datepicker" name="EndDate">
                                            <input required type="time" class="date-picker" type="text" id="datepicker" name="EndTime">
