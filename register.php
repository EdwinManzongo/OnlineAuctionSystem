                    ...
                    <div class="box">
                        ...
                        <form action="process_register.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="natid" name="natid">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box">
                        ...
                        <?php 
                            ...
                            if(isset($_GET['err']) && $_GET['err'] == 3) {
                                echo '
                                <div class="alert alert-danger">
                                    <strong>Error!</strong> Please login to place bids.
                                </div>
                                ';
                            }
                            ...
                            if(isset($_GET['err']) && $_GET['err'] == 4) {
                                echo '
                                <div class="alert alert-danger">
                                    <strong>Error!</strong> Account has been blacklisted. Please contact the Administrator.
                                </div>
                                ';
                            }
                        ?>
