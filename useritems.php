...
<body>
        ...
        <?php 
            ...
            $query3 = "SELECT DISTINCT bids.ItemID, item.itemID, item.PhotosID, item.ItemName, item.CurrentPrice, bids.BidderID, bids.BidAmount, user.UserID FROM item 
                    ...
                    <div class="col-md-3 col-sm-4">
                            <div class="product">
                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.php?ItemNo=<?php echo $userResults['ItemID'] ?>">
                                                <img src="img/<?php echo $userResults['PhotosID'];?>" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.php?ItemNo=<?php echo $userResults['ItemID'] ?>">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price">ZWL$ <?php echo number_format($userResults['CurrentPrice'],2);?></p>
                                    <p class="buttons">
                    ...
                    <div class="col-md-3 col-sm-4">
                            <div class="product">
                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.php?ItemNo=<?php echo $userBids['ItemID'] ?>">
                                                <img src="img/<?php echo $userBids['PhotosID'];?>" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.php?ItemNo=<?php echo $userBids['ItemID'] ?>">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price">ZWL$ <?php echo number_format($userBids['BidAmount'],2);?></p>
                                     <p align="center">Current Max Bid</p>
                                    <p class="price">ZWL$ <?php echo number_format($userBids['CurrentPrice'],2);?></p>
                                    <p class="buttons">
