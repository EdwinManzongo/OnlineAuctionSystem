<?php 
    ...
    $query = "SELECT * FROM solditems WHERE InvoiceNumber = '$InvoiceNumber'";
    $result = mysqli_query($db, $query);
    $row = mysqli_fetch_array($result);

    $amount = $row['FinalValue'];
    $amount = (0.95 * $amount);
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    ...
                    <div class="box" id="contact">
                        ...
                        <form class="form-horizontal" method="POST" action="transfer_payment.php">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div id="collapseTwo" class="panel">
                                    <div class="alert alert-success"> <p class="text-center"> <?php if (isset($msg)) { echo $msg; } ?> </div> </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-inline">
                                                ...
                                                <input type="text" class="form-control" name="PaymentAmount" value="<?php echo $amount; ?>">
                                            </div> 
                                        <br>
                                        </div>
                        ...
                        <br>
                         ...
                         <input type="submit" align ="left" class="btn btn-primary center-block" type="submit" name="SubmitTransfer" value="Submit Payment">
